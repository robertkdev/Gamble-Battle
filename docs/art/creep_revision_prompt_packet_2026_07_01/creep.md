...
- Unit id: `creep`
- Matrix section: `other_units`
- Source image: `assets/units/creep.png`
- Resource path: `data/other_units/other/creep.tres`
- Traits: `Exile, Executioner`
- Coverage groups: `other_unit, goth_horror_anchor, monster_assassin, detached_effects`

## Coverage Notes

- `other_unit`: Art-bearing UnitProfile resources outside the playable shop roster, including hidden/enemy-only implementations and planned units under data/other_units/other.
