...
Creep v5 is the explicitly approved live horror-side result, not a global style anchor. The live repo stores him as a playable Assassin unit at `data/units/creep.tres` with Exile / Executioner traits and the Evesdropping ability: a lowest-health dash into rapid spinning strikes, unstoppable and damage-reduced while spinning, with Exile extending the spin and chaining to the next lowest-health enemy on takedown. Treat Creep as a real planned unit and roster identity, not a generic creep-wave monster. His identity depends on a smooth oval alien face, black hollow eye sockets, smooth gray-blue alien skin, and black blade tendrils. Do not turn him into a ripped-apart corpse, flayed anatomy study, wet gore monster, or generic dead-flesh horror creature. Preserve the accepted v5 pass unless the user explicitly reverses its approval.

Use Creep v5 as narrow evidence that creepy humanoid, demon, cursed, or body-horror figures can remain readable and premium. Use Paisley as the only secondary contrast anchor: she can be brighter and stranger, but her contrast should sit inside the same dry gothic material rules rather than pulling the whole game into cartoon gloss. Vellum remains the sole primary/ultimate material and detail authority. Earlier Creep candidates remain process history and negative evidence; they must not be averaged into the target or silently promoted over the approved live v5 result.
