...
- `docs/art/unit_art_creep_process_research_2026-07-01.md` records the useful Creep generation process as research: identity lock first, Vellum-first material comparison, prior candidates as evidence/negative comparisons rather than anchors, dry detail through surface weathering, and no definitive promotion without human review. It also records the Totem research candidates generated from that process, including v5 as the cleaner board-scale balance and v6 as the stronger material/torso correction.
