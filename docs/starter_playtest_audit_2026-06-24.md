...
- Current post-shop betting economy guard: `tests/visual/BettingEconomySmoke.tscn`
...
- `tests/visual/BettingEconomySmoke.tscn`: `BettingEconomySmoke: OK`, `errors: []`.
