...
- Current RoleMatrix accepted-miss artifacts: `outputs/audit_playtest/rga_accepted_misses_2026_06_25/` and the local HEAD refresh `outputs/audit_playtest/rga_accepted_misses_2026_06_26_head_refresh/`
