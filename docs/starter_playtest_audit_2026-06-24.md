...
- Current rapid shop pressure guards: `tests/visual/RapidShopPressureSmoke.tscn` and `tests/visual/ProductionRapidShopPressureSmoke.tscn`
...
Current branch snapshot: refreshed on 2026-06-26 local main after the Unit Select, deploy-assist/watchdog, shop-spacing, audit-validation, strict-input, shop/economy hardening, all-starter Main-flow, and Totem residual follow-ups; latest RGA residual checkpoint was run at local HEAD `f625879`.
...
- The tracked validation now covers both accelerated and production-clock timing for this path, and the production-clock path uses rendered-card viewport clicks rather than direct card signals. The real-window buying portion is also covered for OS-coordinate clicks under a staged Round 2 setup. Remaining risk is physical pointer feel, hit-target clarity, deployment drag feel, and purchase-feedback prominence under normal human play pressure.
