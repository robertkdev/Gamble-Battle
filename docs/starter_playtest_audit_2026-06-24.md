...
- Current audit interpretation: the mechanical blockers, normal first-shop default-card quality, known first-shop trap-card exposure, fallback retry-shop default-card quality, and one deterministic mid-run planned line are covered for the current sensitive starters; the live design backlog is broader random later-choice quality, starter pacing, and fresh real-window screenshot evidence outside the protected opening-shop path.
