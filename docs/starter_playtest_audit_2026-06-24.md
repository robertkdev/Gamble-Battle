...
| Debuff/lockdown counterplay on Brute, Kythera, Sari, and Volt | 9 | Live `counterplay` rows now exist. Brute still has a high-tenacity effective-drop miss; Kythera and Sari still lack enough cleanse pressure, cleanse-bait, or scenario-delta response; Volt has lockdown scenario-delta misses for negative cleanse delta and 0 high-tenacity effective drop. Grint now passes the live debuff counterplay scenario and is no longer in this triage group. | Counterplay telemetry exists and the scenario harness is live; remaining rows need content/scenario tuning, different response composition, or retagging if these identities should not require cleanse/high-tenacity response pressure. |
