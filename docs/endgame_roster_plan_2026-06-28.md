...
Status: partially implemented. The original plan remains the target-matrix source, while live resources now include the first cost-1/cost-2 batch, Sari traits, playable Creep, and the planned cost-3 batch through Sable.
