	...
	return [
		{
			...
			"baseline_team": ["brute", "sari", "volt", "laith"],
		...
		},
		{
			...
			"counter_team": ["korath", "sari", "laith", "axiom"],
			"baseline_team": ["brute", "sari", "laith", "axiom"],
			"threat_team": ["pilfer", "bo", "creep", "hexeon"],
			"protected_index": 1,
			"baseline_protected_index": 1,
			"min_score_delta": 20.0,
		...
		},
		{
			...
			"baseline_team": ["brute", "luna", "laith", "sari"],
		...
		},
		{
			...
			"baseline_team": ["kythera", "sari", "axiom", "laith"],
