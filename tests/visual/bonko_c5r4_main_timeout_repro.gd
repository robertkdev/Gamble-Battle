...
const PLAYER_IDS: Array[String] = ["bonko", "kythera", "volt", "nyxa", "luna", "omenry", "hexeon", "veyra", "paisley"]
const BENCH_IDS: Array[String] = ["berebell", "mortem", "laith", "sari", "morrak", "korath", "vykos"]
const CHAPTER: int = 5
