...
const TARGET_STARTERS: Array[String] = ["axiom", "bo", "bonko", "laith", "korath", "morrak", "mortem", "repo", "sari"]
const TARGET_HELPERS: Dictionary = {
	"axiom": ["sari", "sari", "sari", "sari", "sari"],
	"bo": ["berebell", "laith", "laith", "grint", "brute"],
	"bonko": ["morrak", "grint", "mortem", "axiom", "korath"],
	"laith": ["korath", "repo", "brute", "bonko", "brute"],
